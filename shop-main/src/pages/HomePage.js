        ...
        {displayName && (
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 text-emerald-900">
            <p className="text-sm font-medium">
              {" "}
              WELCOME TO GARNDEN SHOP,{" "}
              <span className="font-semibold">{displayName}</span>.
            </p>
            <p className="text-xs text-emerald-800/80">
              You're signed in. Continue exploring the marketplace.
            </p>
          </div>
        )}
      </motion.section>
      <main className="mx-auto max-w-6xl px-6 py-12">
        <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-emerald-600">
              Premium Horticulture and Processing Marketplace
            </p>
            <h1 className="mt-6 text-5xl font-semibold tracking-tight text-slate-900">
              Cultivate your perfect garden with premium plants, tools, and
              expert guidance.
            </h1>
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-700">
              Login to access exclusive gardening supplies, track your plant
              orders, schedule deliveries, and join our community of passionate
              gardeners.
            </p>
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                to="/shop"
                className="rounded-full bg-emerald-700 px-6 py-3 text-slate-900 shadow hover:bg-emerald-800"
              >
                Browse Garden Supplies
              </Link>
              <Link
                to="/register"
                className="rounded-full border border-slate-300 px-6 py-3 text-slate-900 hover:bg-slate-50"
              >
                Join Our Garden
              </Link>
            </div>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h2 className="text-2xl font-semibold text-slate-900">
                Trusted nurseries powering our marketplace
              </h2>
            </div>
            <Link
              to="/shop"
              className="inline-flex items-center rounded-full bg-emerald-700 px-6 py-3 text-slate-900 hover:bg-emerald-800"
            >
            ...
            {[
              {
                ...
                description:
                  "Fresh organic vegetables, heirloom tomatoes, and seasonal crop boxes delivered weekly.",
                tags: ["tomatoes", "vegetables", "organic"],
              },
              {
                name: "Motheo Greens",
                description:
                  "Farm-fresh salad greens, culinary herbs, and mixed vegetable bundles from local farmers.",
                tags: ["salad", "herbs", "fresh"],
              },
              {
                name: "Root & Stem Farms",
                description:
                  "Specialty root vegetables, heirloom carrots, and colorful bell peppers grown sustainably.",
        ...
        <section className="mt-12">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-semibold text-slate-900">
              Sell Your Produce on Our Platform
            </h2>
            <p className="mt-2 text-sm text-slate-600 max-w-2xl mx-auto">
              To list your vegetables, crops, or garden products for sale, you
              must register and maintain an active subscription. This ensures
              quality control, reliable supply, and fair pricing for all
              customers.
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border-2 border-emerald-300 p-6 bg-white shadow-lg relative">
              ...
              <div className="flex items-center justify-between mt-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Farms, nurseries, and agricultural cooperatives
                  </p>
                </div>
              ...
              <div className="mt-6">
                <Link
                  to="/register"
                  className="inline-block w-full text-center rounded-full bg-emerald-700 px-5 py-3 text-white font-medium hover:bg-emerald-800"
                >
            ...
            <div className="rounded-2xl border-2 border-emerald-300 p-6 bg-white shadow-lg relative">
              ...
              <div className="flex items-center justify-between mt-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Small-scale growers and hobby farmers
                  </p>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold text-emerald-700">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="mt-2 text-sm text-amber-700 space-y-1">
                  <li>
                    {" "}
                    <strong>Monthly billing only</strong> No annual plans
                    available. Subscriptions renew automatically each month.
                  </li>
                  <li>
                    {" "}
                    <strong>Product approval required</strong> All listed
                    products must meet our quality and safety standards before
                    going live.
                  </li>
                  <li>
                    {" "}
                    <strong>Active subscription required</strong> Your products
                    will be hidden if your subscription lapses.
                  </li>
                  <li>
                    {" "}
                    <strong>Cancel anytime</strong> No long-term commitments,
                    but no prorated refunds for partial months.
                  </li>
                </ul>
              </div>
            </div>
